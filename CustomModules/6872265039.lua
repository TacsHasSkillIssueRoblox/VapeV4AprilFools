...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/TacsHasSkillIssueRoblox/VapeV4AprilFools/main/"..scripturl, true)
	end
end
...
spawn(function()
	local url = "https://raw.githubusercontent.com/TacsHasSkillIssueRoblox/VapeV4AprilFools/main/CustomModules/bedwarsdata"
